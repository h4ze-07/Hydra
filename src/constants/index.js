...
import {
	...
	unrealEngine,
	vive,
} from "../assets/images/indedx";

export const headerVars = {
	headerDesktopStyles: {
		container:
			"hidden md:flex items-center gap-5 lg:gap-[60px] xl:gap-[140px]",
		links: "flex gap-3 lg:gap-[25px] xl:gap-[41px]",
		btns: "flex gap-2 lg:gap-[15px] xl:gap-[25px]",
	},

	headerMobileStyles: {
		container:
			"absolute left-0 top-0 mt-[89px] w-[100vw] h-[100dvh] bg-[#302C42] z-[9] flex flex-col gap-[40px] md:hidden",
	...
	headerBtns: [
		{
			title: "CONTACT",
			btnStyles:
				"headerBtn1 border border-white rounded-[40px] overflow-hidden",
			pStyles:
				"text-[12px] text-white font-bold py-[13px] px-[36px] w-full h-full",
		},
		{
			title: "JOIN HYDRA",
			btnStyles:
				"border-2 border-[transparent] rounded-[40px] overflow-hidden",
			pStyles:
				"headerBtnGradient text-[12px] text-[#343045] font-bold py-[13px] px-[38px]",
		},
	],
};
